    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="text-center">
                            ...
                            <div class="form-check">
								<label>3. Scan Kartu Keluarga</label>
				...
				<form action="{{ route('customer.create.step.five.post')}}" method="POST" enctype="multipart/form-data">
								 @csrf
								 <div class="col-md-6">
            <div class="text-center">
					...
					<div class="form-group">
						...
						<input type="file" name="s_kk" accept="image/*;capture=camera"  required="">
						</label>
					</div>
      </div>
