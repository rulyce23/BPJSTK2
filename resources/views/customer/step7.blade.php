    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="text-center">
                            ...
                            <div class="form-check">
								<label>5. Scan Buku Tabungan</label>
				...
				<form action="{{ route('customer.create.step.seven.post')}}" method="POST" enctype="multipart/form-data">
								 @csrf
								 <div class="col-md-6">
            <div class="text-center">
					...
					<div class="form-group">
						<b>File Gambar</b><br/>
						<input type="file" name="s_tabung"   accept="image/*" capture required="">
					</div>
      </div>
